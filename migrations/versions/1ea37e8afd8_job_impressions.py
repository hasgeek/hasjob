...
def upgrade():
    op.create_table('job_impression',
    ...
    op.create_index(op.f('ix_job_impression_event_session_id'), 'job_impression', ['event_session_id'], unique=False)
    op.drop_index('ix_starred_job_jobpost_id', table_name='starred_job')


def downgrade():
    op.create_index('ix_starred_job_jobpost_id', 'starred_job', ['jobpost_id'], unique=False)
    op.drop_index(op.f('ix_job_impression_event_session_id'), table_name='job_impression')
