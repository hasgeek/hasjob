...
def upgrade():
    ...
    op.add_column('board', sa.Column('newjob_headline', sa.Unicode(length=100), nullable=True))
    op.add_column('board', sa.Column('require_login', sa.Boolean(), nullable=False, server_default='1'))
