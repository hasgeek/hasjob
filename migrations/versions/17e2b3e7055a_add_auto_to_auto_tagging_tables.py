...
def upgrade():
    ...
    op.create_primary_key('board_auto_domain_pkey', 'board_auto_domain', ['board_id', 'domain'])
    op.create_index('ix_board_auto_domain_domain', 'board_auto_domain', ['domain'])
    op.create_foreign_key('board_auto_domain_board_id_fkey', 'board_auto_domain', 'board', ['board_id'], ['id'])
    ...
    op.drop_constraint('board_location_board_id_fkey', 'board_location', type_='foreignkey')
    op.rename_table('board_location', 'board_auto_location')
    op.create_primary_key('board_auto_location_pkey', 'board_auto_location', ['board_id', 'geonameid'])
    op.create_index('ix_board_auto_location_geonameid', 'board_auto_location', ['geonameid'])
    op.create_foreign_key('board_auto_location_board_id_fkey', 'board_auto_location', 'board', ['board_id'], ['id'])


def downgrade():
    op.drop_constraint('board_auto_location_pkey', 'board_auto_location', type_='primary')
    op.drop_index('ix_board_auto_location_geonameid', 'board_auto_location')
    op.drop_constraint('board_auto_location_board_id_fkey', 'board_auto_location', type_='foreignkey')
    op.rename_table('board_auto_location', 'board_location')
    op.create_primary_key('board_location_pkey', 'board_location', ['board_id', 'geonameid'])
    op.create_index('ix_board_location_geonameid', 'board_location', ['geonameid'])
    op.create_foreign_key('board_location_board_id_fkey', 'board_location', 'board', ['board_id'], ['id'])
    ...
    op.drop_constraint('board_auto_domain_board_id_fkey', 'board_auto_domain', type_='foreignkey')
    ...
    op.create_foreign_key('board_domain_board_id_fkey', 'board_domain', 'board', ['board_id'], ['id'])
