...
def upgrade():
    op.add_column('campaign_anon_view', sa.Column('last_viewed_at', sa.DateTime(), nullable=True))
    op.add_column('campaign_anon_view', sa.Column('reset_at', sa.DateTime(), nullable=True))
    op.execute(campaign_anon_view.update().values(
        {'last_viewed_at': campaign_anon_view.c.updated_at, 'reset_at': campaign_anon_view.c.datetime}))
    ...
    op.add_column('campaign_view', sa.Column('last_viewed_at', sa.DateTime(), nullable=True))
    op.add_column('campaign_view', sa.Column('reset_at', sa.DateTime(), nullable=True))
    op.execute(campaign_view.update().values(
        {'last_viewed_at': campaign_view.c.updated_at, 'reset_at': campaign_view.c.datetime}))
