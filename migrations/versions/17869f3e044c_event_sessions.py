...
def upgrade():
    ...
    op.create_index(op.f('ix_anon_user_user_id'), 'anon_user', ['user_id'], unique=False)
    ...
    op.create_index(op.f('ix_event_session_anon_user_id'), 'event_session', ['anon_user_id'], unique=False)
    op.create_index(op.f('ix_event_session_user_id'), 'event_session', ['user_id'], unique=False)
