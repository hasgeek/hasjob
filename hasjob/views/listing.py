            ...
            if g.user.blocked:
                ...
                try:
                    if 'apply_document' in request.files:
                        ...
                        doc_view_url = request.url_root[:-1] + rel_doc_view_url
                        applyform.apply_message.data += "<hr />Click <a href='"+ doc_view_url  + \
                                                        "'>here</a> to view the document uploaded by the applicant."
