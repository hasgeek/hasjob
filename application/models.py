...
class User(db.Model):
    ...
    userid = db.Column(db.String(22), nullable=False, unique=True,
                        default=newid)
...
class JobPost(db.Model):
    ...
    type_id = db.Column(db.Integer, db.ForeignKey('jobtype.id'),
                    nullable=False)
    type = db.relation(JobType, primaryjoin=type_id == JobType.id)
    category_id = db.Column(db.Integer, db.ForeignKey('jobcategory.id'),
                        nullable=False)
    ...
    edit_key = db.Column(db.String(40), nullable=False,
                        default=random_long_key)
    email_verify_key = db.Column(db.String(40), nullable=False,
                                default=random_long_key)
...
class JobPostReport(db.Model):
    ...
    post_id = db.Column(db.Integer, db.ForeignKey('jobpost.id'),
                    nullable=False)
    post = db.relation(JobPost, primaryjoin=post_id == JobPost.id)
    reportcode_id = db.Column(db.Integer, db.ForeignKey('reportcode.id'),
                    nullable=False)
