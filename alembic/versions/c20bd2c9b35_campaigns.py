...
def upgrade():
    ...
    op.create_table('campaign_board',
        sa.Column('created_at', sa.DateTime(), nullable=False),
        sa.Column('updated_at', sa.DateTime(), nullable=False),
    ...
    op.create_index(op.f('ix_campaign_board_campaign_id'), 'campaign_board', ['campaign_id'], unique=False)
    op.create_table('campaign_view',
        sa.Column('created_at', sa.DateTime(), nullable=False),
        sa.Column('updated_at', sa.DateTime(), nullable=False),
        sa.Column('campaign_id', sa.Integer(), nullable=False),
    ...
    op.create_table('campaign_location',
        sa.Column('created_at', sa.DateTime(), nullable=False),
        sa.Column('updated_at', sa.DateTime(), nullable=False),
        sa.Column('campaign_id', sa.Integer(), nullable=False),
    ...
    op.create_index(op.f('ix_campaign_location_geonameid'), 'campaign_location', ['geonameid'], unique=False)
    op.create_table('campaign_action',
        sa.Column('id', sa.Integer(), nullable=False),
        sa.Column('created_at', sa.DateTime(), nullable=False),
        sa.Column('updated_at', sa.DateTime(), nullable=False),
        sa.Column('campaign_id', sa.Integer(), nullable=False),
        sa.Column('public', sa.Boolean(), nullable=False),
        sa.Column('type', sa.Enum('D', 'F', 'L', 'M', 'N', 'Y', name='campaign_action_type_enum'), nullable=False),
    ...
    op.create_table('campaign_user_action',
        sa.Column('id', sa.Integer(), nullable=False),
        sa.Column('created_at', sa.DateTime(), nullable=False),
        sa.Column('updated_at', sa.DateTime(), nullable=False),
    ...
    op.create_index(op.f('ix_campaign_user_action_action_id'), 'campaign_user_action', ['action_id'], unique=False)
    op.create_index(op.f('ix_campaign_user_action_user_id'), 'campaign_user_action', ['user_id'], unique=False)
    op.create_index(op.f('ix_userjobview_user_id'), 'userjobview', ['user_id'], unique=False)
